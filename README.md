...
UniSync is a unified platform that bridges the gaps in campus life by connecting students for peer collaboration, skill exchange, and resource sharing. Built with Streamlit and powered by Google Gemini AI.
...
UniSync combines three powerful features:
...
- **Data:** CSV-based storage (users, listings, connections, passwords)
- **Deployment:** Streamlit Cloud

## 🚀 Features

✅ User authentication (signup/login/logout)
✅ Profile management with X-Factors
✅ Swipe-based peer discovery
✅ Advanced filtering and sorting
✅ AI-powered matchmaking
✅ Persistent connections across sessions
✅ Skill categorization (Tech/Creative/Academic/Other)
✅ Campus marketplace with multiple categories
✅ Responsive glassmorphism UI

## 📊 Demo Data

- 15 student profiles across different majors and years
- 18 marketplace listings (rooms, furniture, electronics, textbooks)
- Real IIT Delhi context and locations

## 👥 Team

- **Yuvraj Sarathe** - Full-stack development, AI integration, architecture
- **Siddhika Dhanelia** - Peer matching, skill swap, frontend polish
- **Aaradhya Tiwari** - Dorm deals, filtering/sorting, dummy data
